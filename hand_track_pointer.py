...
class handDetector():
    def __init__(self, mode=False, model_comp=1, maxHands=2, detectionCon=0.5, trackCon=0.5):  # constructor
        self.mode = mode
        ...
        self.hands = self.mpHands.Hands(self.mode, self.maxHands, self.model_comp, self.detectionCon,
